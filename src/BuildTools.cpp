...
static void GenerateJoinArgs(const Blob<const BuildCommandInfo> &params, std::string *results);
...
std::vector<int> build_tools::Execute_Multithreaded(const Blob<const BuildCommandInfo> &params,
                                                    uint32_t batches) {
