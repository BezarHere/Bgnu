...
public:
  ...
  static inline ConsoleColor get_bg_color() { return s_bg; }

  static inline ConsoleColor get_fg_color() { return s_fg; }
...
// for empty args
static inline void _format_join(std::ostream &stream) { (void)stream; }
...
static inline void _format_join(std::ostream &stream, const T1 &value1, const T2 &value2,
                                const VArgs &...args) {
  stream << value1;
