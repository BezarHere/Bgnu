...
enum class WarningLevel : uint8_t { None = 0, All, Extra };
...
enum class BuildType : uint8_t { Binary, Library, Intermediates };
...
enum class BuildConfigurationDefaultType { Debug, Release };
