...
public:
	...
	{ "c++", SourceFileType::CPP },
	{ "hpp", SourceFileType::CPP },
	{ "hh", SourceFileType::CPP },
	{ "hxx", SourceFileType::CPP },
	{ "h++", SourceFileType::CPP },
...
inline bool SourceTools::is_compatable_types(SourceFileType type, SourceFileType partner) {
	...
	{
		if (type == CompatableSourceTypeTable[i].first && partner == CompatableSourceTypeTable[i].second)
		{
			return true;
		}
	}
