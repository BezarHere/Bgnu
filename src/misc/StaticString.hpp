...
public:
  ...
  constexpr BasicStaticString(std::nullptr_t) : BasicStaticString() {}
  ...
  constexpr BasicStaticString(const char_type *cstr) : BasicStaticString(cstr, _length(cstr)) {}

  constexpr explicit BasicStaticString(const char_type _char) : m_length{ _char != char_type() } {
  ...
  inline bool operator!=(const char_type *other) const { return !(*this == other); }

  inline operator string_type() const { return string_type(m_data, m_length); }
  ...
  inline constexpr size_t length() const { return m_length; }
  ...
  inline constexpr const value_type *c_str() const { return m_data; }

  inline constexpr value_type *begin() { return m_data; }
  inline constexpr value_type *end() { return m_data + m_length; }
...
template <size_t _MaxLen, typename _T>
inline constexpr size_t BasicStaticString<_MaxLen, _T>::_length(const char_type *src,
                                                                size_t max_length) {
...
template <size_t _MaxLen, typename _T>
inline constexpr bool BasicStaticString<_MaxLen, _T>::_equality(const container_type &left,
...
template <size_t _MaxLen, typename _T>
inline constexpr bool BasicStaticString<_MaxLen, _T>::_equality(const char_type *left,
